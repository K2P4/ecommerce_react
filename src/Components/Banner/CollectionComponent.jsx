...
const CollectionComponent = () => {
  return (
    <Container maxWidth="lg">
      <section className="py-16 container md:py-24 min-h-full flex items-center justify-center mx-auto bg-gray-50 relative">
        ...
        <div className="container mx-auto flex flex-col  md:flex-row items-center justify-between px-4 z-10">
          ...
          <Box className="flex flex-col items-center md:items-start text-center md:text-left mb-10 md:mb-0">
            ...
            <p className="text-base md:text-lg text-gray-600 mb-8 max-w-md font-light">
              Explore an exquisite range of captivating fragrances, crafted to
              evoke elegance and leave a lasting impression.
            </p>
            <button className="group relative bg-gray-900 text-white px-10 py-4 rounded-full font-medium text-lg transition-all duration-300 hover:bg-gray-800 hover:scale-105 hover:shadow-2xl flex items-center gap-3 justify-center">
