        ...
        getStocks: builder.query({
            query: ({
                ...
                const priceParam = Array.isArray(priceRange) ?
                    ...
                    priceRange;
                return {
                    url: `/stocks?search=${search}&page=${page}&perpage=${perpage}&onlyInStock=${onlyInStock}&rating=${rating}&discount=${discount}&time=${time}&sort=${sort}&priceRange=${priceParam}&branch=${branch}&categories=${categories}`,
                    method: "GET",
                };
            },
            providesTags: ["stocks"],
